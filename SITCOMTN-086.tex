...
on-chip amplifier which has an ``on chip gain'' of approximately $\sim5 \micro
...
which has an adjustable gain that was set so that the total gain is
approximately 1.7 ADU/electron.
