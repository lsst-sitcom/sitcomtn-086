...
photoelectrons ($\electron$) produced by a source in a pixel is proportional to the
...
%
\begin{equation}
\electron_b = A \int_0^{\Delta T}dt \int_0^\infty
...
%
\begin{equation}
\mobs = -2.5\,\mathrm{log}_{10}(\electron_b) +
...
%
\begin{equation}
\mathrm{ZPT}^{\mathrm{AB}} = 2.5\,\mathrm{log}_{10} \left (
\frac{A\,F^{\mathrm{AB}}}{h_{\mathrm{Pl}}} \frac ),
\end{equation}
%
